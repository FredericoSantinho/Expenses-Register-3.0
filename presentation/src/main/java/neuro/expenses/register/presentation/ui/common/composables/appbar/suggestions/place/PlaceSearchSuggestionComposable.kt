package neuro.expenses.register.presentation.ui.common.composables.appbar.suggestions.place
...
import neuro.expenses.register.presentation.R.string
...
fun PlaceSearchSuggestionTitleComposable() {
  Column {
    Row(horizontalArrangement = Arrangement.Center, modifier = Modifier.fillMaxWidth()) {
      Text(
        stringResource(string.search_place_title),
