...
fun neuro.expenses.register.entity.expense.validator.RegisterExpenseError.toDomain(): RegisterExpenseError =
  when (this) {
    ...
    neuro.expenses.register.entity.expense.validator.RegisterExpenseError.INVALID_CATEGORY -> RegisterExpenseError.INVALID_CATEGORY
...
fun Set<neuro.expenses.register.entity.expense.validator.RegisterExpenseError>.toDomain(): List<RegisterExpenseError> =
  map { it.toDomain() }