...
//  @Test
//  fun contains() {
//    val bill = Bill("place", 1, 1.0, listOf(BillItem(Product("description", "cat", 1.0), 1.0)))
//    val calculateBillTotal = mock<CalculateBillTotal> {}
//    val billController = BillController(calculateBillTotal, bill)
//
//    Assert.assertTrue(billController.contains("description"))
//    Assert.assertFalse(billController.contains("desc1"))
//  }
//
//  @Test
//  fun add() {
//    val billItem = BillItem(Product("description", "cat", 1.0), 1.0)
//    val bill = Bill(
//      "place",
//      1, 2.0,
...
//    val billController = BillController(calculateBillTotal, bill)
//
//    Assert.assertEquals("description", billController.bill.billItems.get(0).product.description)
